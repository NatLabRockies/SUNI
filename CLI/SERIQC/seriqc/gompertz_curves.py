# fmt: off
"""Functions and data related to Gompertz boundary curves used by SERI QC."""
import numpy as np


def boundary_from_gompertz_curve(shape_number, position_number, side):
    """Calculate boundary points based on SERI QC Gompertz curve integers.
    ...
    side : {'left', 'right'}
        Option of left or right boundary curve (input is
        case-insensitive).

    Returns
    -------
    boundary : array
        A 2xN array with coordinates (Kt, Kn) of the boundary.

    Notes
    -----
    The returned coordinates values are fractions, and NOT in integer
    percentages.
    """
    # The horizontal offset is positive in the direction of increasing Kt
    Kt_offset = 2.5 * (position_number - 1)

    if side.casefold() not in ['left', 'right']:
    ...
    # The corresponding Kn values range from 0.01 to 1
    Kns = np.arange(0.01, 1.01, 0.01)

    return np.vstack([Kts, Kns])


# The following is a comment from the original SERI-QC C code:
...
# The Gompertz curve values are provided below. The values are
# in terms of Kt, and correspond to the integers between 1 and 100
# of Kn. Note, the values are in percentages.

GOMPERTZ_CURVES_LEFT = [
    ...
    [-60.0, -60.0, -0.9, 0.1,  1.2,  2.3,  3.4,  4.4,  5.5,  6.6,
     7.6,   8.6,   9.7,10.7, 11.7, 12.7, 13.7, 14.7, 15.7, 16.6,
     17.6, 18.6,  19.5,20.5, 21.4, 22.4, 23.3, 24.2, 25.2, 26.1,
     27.0, 27.9, 28.8, 29.7, 30.6, 31.5, 32.4, 33.3, 34.1, 35.0,
     35.9, 36.7, 37.6, 38.5, 39.3, 40.2, 41.0, 41.8, 42.7, 43.5,
     44.4, 45.2, 46.0, 46.9, 47.7, 48.5, 49.3, 50.1, 51.0, 51.8,
     52.6, 53.4, 54.2, 55.0, 55.8, 56.6, 57.5, 58.3, 59.1, 59.9,
     60.7, 61.5, 62.3, 63.1, 63.9, 64.7, 65.5, 66.3, 67.1, 67.9,
     68.7, 69.5, 70.4, 71.2, 72.0, 72.8, 73.6, 74.4, 75.3, 76.1,
     76.9, 77.7, 78.6, 79.4, 80.2, 81.1, 81.9, 82.7, 83.6, 84.4],

     [-60.0,-60.0,-4.2,-3.0, -1.7, -0.5,  0.7,  1.9,  3.0,  4.2,
     5.4,   6.5,  7.7,  8.8,  9.9, 11.0, 12.1, 13.2, 14.3, 15.4,
     16.5, 17.5, 18.6, 19.6, 20.6, 21.7, 22.7, 23.7, 24.7, 25.7,
     26.6, 27.6, 28.6, 29.5, 30.4, 31.4, 32.3, 33.2, 34.1, 35.0,
     35.9, 36.8, 37.6, 38.5, 39.3, 40.2, 41.0, 41.8, 42.7, 43.5,
     44.3, 45.1, 45.8, 46.6, 47.4, 48.1, 48.9, 49.6, 50.4, 51.1,
     51.8, 52.5, 53.2, 53.9, 54.6, 55.3, 55.9, 56.6, 57.2, 57.9,
     58.5, 59.1, 59.8, 60.4, 61.0, 61.6, 62.2, 62.8, 63.3, 63.9,
     64.5, 65.0, 65.6, 66.1, 66.6, 67.1, 67.7, 68.2, 68.7, 69.2,
     69.6, 70.1, 70.6, 71.1, 71.5, 72.0, 72.4, 72.8, 73.3, 73.7]
]

GOMPERTZ_CURVES_RIGHT = [
    ...
    [17.3, 18.3, 19.2, 20.1, 21.0, 21.9, 22.8, 23.6, 24.5, 25.3,
     26.2, 27.0, 27.8, 28.6, 29.4, 30.2, 31.0, 31.8, 32.5, 33.3,
     34.1, 34.8, 35.5, 36.3, 37.0, 37.7, 38.4, 39.2, 39.9, 40.6,
     41.3, 42.0, 42.7, 43.4, 44.1, 44.8, 45.4, 46.1, 46.8, 47.5,
     48.2, 48.9, 49.6, 50.2, 50.9, 51.6, 52.3, 53.0, 53.7, 54.4,
     55.1, 55.8, 56.5, 57.2, 57.9, 58.6, 59.4, 60.1, 60.8, 61.6,
     62.3, 63.1, 63.8, 64.6, 65.4, 66.1, 66.9, 67.7, 68.5, 69.3,
     70.2, 71.0, 71.8, 72.7, 73.6, 74.4, 75.3, 76.2, 77.1, 78.1,
     79.0, 79.9, 80.9, 81.9, 82.9, 83.9, 84.9, 85.9, 87.0, 88.0,
     89.1, 90.2, 91.3, 92.4, 93.6, 94.7, 95.9, 97.1, 98.3, 99.6],

    [12.7, 13.9, 15.1, 16.3, 17.5, 18.6, 19.8, 20.8, 21.9, 23.0,
     24.0, 25.0, 26.0, 27.0, 27.9, 28.8, 29.7, 30.6, 31.5, 32.4,
     33.2, 34.1, 34.9, 35.7, 36.5, 37.3, 38.1, 38.8, 39.6, 40.3,
     41.1, 41.8, 42.5, 43.2, 44.0, 44.7, 45.4, 46.1, 46.8, 47.5,
     48.2, 48.9, 49.6, 50.3, 51.0, 51.7, 52.4, 53.2, 53.9, 54.6,
     55.3, 56.1, 56.8, 57.6, 58.3, 59.1, 59.9, 60.7, 61.5, 62.3,
     63.2, 64.0, 64.9, 65.8, 66.7, 67.6, 68.5, 69.4, 70.4, 71.4,
     72.4, 73.4, 74.5, 75.6, 76.6, 77.8, 78.9, 80.1, 81.3, 82.5,
     83.7, 85.0, 86.3, 87.7, 89.0, 90.4, 91.8, 93.3, 94.8, 96.3,
     97.9, 99.5,101.1,102.8,104.5,106.2,108.0,109.8,111.7,113.6]
]
